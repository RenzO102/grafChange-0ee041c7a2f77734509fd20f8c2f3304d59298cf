...
public class AccountResource {
    ...
    @GetMapping("/quarters")
    public List<QuarterFilter> getQuarter() throws Exception {
        return quarter.Quarter();
    }

    @GetMapping("/months")
    public List<MonthsFilter> getMonth() throws Exception {
        return month.Month();
    }

    @GetMapping("/weeks")
    public List<WeeksFilter> getWeek() throws Exception {
        return week.Week();
    }
